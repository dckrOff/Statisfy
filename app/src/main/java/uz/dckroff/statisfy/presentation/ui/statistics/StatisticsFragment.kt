...
import uz.dckroff.statisfy.presentation.viewmodel.StatisticsUiState
...
class StatisticsFragment : Fragment() {
     ...
     */
    private fun showStatistics(state: StatisticsUiState) {
     ...
     */
    private fun buildStatisticsItems(state: StatisticsUiState): List<StatisticsItem> {
        ...
        if (state.filteredStatistics.isNotEmpty()) {
            ...
            state.filteredStatistics.forEach { statistic ->
                items.add(
                    StatisticsItem.StatisticRecord(
                        id = statistic.id,
