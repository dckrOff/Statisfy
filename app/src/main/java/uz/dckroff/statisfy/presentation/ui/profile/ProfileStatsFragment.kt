...
/**
 * Фрагмент детальной статистики пользователя
 */
class ProfileStatsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // TODO: Создать полноценный лейаут для статистики
        return inflater.inflate(android.R.layout.simple_list_item_1, container, false).apply {
            findViewById<android.widget.TextView>(android.R.id.text1).text = "Детальная статистика\n(В разработке)"
        }
    }
}