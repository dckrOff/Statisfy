...
/**
 * Фрагмент управления аккаунтом пользователя
 */
class ProfileAccountFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // TODO: Создать полноценный лейаут для управления аккаунтом
        return inflater.inflate(android.R.layout.simple_list_item_1, container, false).apply {
            findViewById<android.widget.TextView>(android.R.id.text1).text = "Управление аккаунтом\n(В разработке)"
        }
    }
}